...
if [[ "$status" != "ENABLED" ]]; then
	...
	echo "$password" | /Applications/Install\ macOS\ Big\ Sur.app/Contents/Resources/startosinstall --eraseinstall --agreetolicense --forcequitapps --newvolumename "Macintosh HD" --user "$loggedInUser" --stdinpass &
fi
